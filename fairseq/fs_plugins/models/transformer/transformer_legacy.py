...
from fs_plugins.models.transformer.transformer_config import (
    TransformerConfig,
    DEFAULT_MAX_SOURCE_POSITIONS,
    DEFAULT_MAX_TARGET_POSITIONS,
    DEFAULT_MIN_PARAMS_TO_WRAP,
)
from fs_plugins.models.transformer.transformer_base import (
    TransformerModelBase,
)


@register_model("transformer_mod")
...
@register_model_architecture("transformer_mod", "transformer_mod_tiny")
...
@register_model_architecture("transformer_mod", "transformer_mod_tiny_2")
def tiny_2_architecture(args):
...
@register_model_architecture("transformer_mod", "transformer_mod_small")
...
@register_model_architecture("transformer_mod", "transformer_mod_big")
def small_architecture(args):
...
@register_model_architecture("transformer_mod", "transformer_mod")
...
@register_model_architecture("transformer_mod", "transformer_mod_iwslt_de_en")
...
@register_model_architecture("transformer_mod", "transformer_mod_wmt_en_de")
